...
Revision ID: 7cdc6ad06cb1
Revises: 
Create Date: 2021-04-05 15:53:34.672181
...
def upgrade():
    ...
    sa.Column('pet_user_fk', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['pet_user_fk'], ['user.email'], ),
    sa.PrimaryKeyConstraint('id')
    )
